                    ...
                    isLoading ? (
                        ...
                        hotels?.map((hotel, index) => (
                            <div
                                ...
                                className={`bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 group animate-slideUp ${viewMode === "list" ? "flex flex-col sm:flex-row" : ""
                                    }`}
