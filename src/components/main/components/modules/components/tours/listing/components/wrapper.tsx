                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="appearance-none bg-filter-bg px-3 lg:px-4 py-2 pr-7 lg:pr-8 rounded-lg text-xs lg:text-sm text-text-muted focus:outline-none focus:ring-2 focus:ring-emerald-600 border-none"
                                >
