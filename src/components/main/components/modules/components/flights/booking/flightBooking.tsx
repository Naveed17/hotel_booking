                        ...
                        <div className="lg:col-span-2">
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <motion.div
                                    ...
                                    className="bg-white/95 relative z-40 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-100 p-8"
                                >
                                ...
                                <motion.div
                                    ...
                                    className="bg-white/95 relative z-0 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-100 p-8"
